...
import { ScrollView, Alert, StyleSheet, ViewStyle } from "react-native";

import { Colors, Typography, View, Text, Avatar, AvatarHelper } from "react-native-ui-lib/src";
...
const examples = [
  ...
  },
  {
    ...
    imageSource: {
      uri:
        "https://lh3.googleusercontent.com/-NQvYunR8V0U/AAAAAAAAAAI/AAAAAAAAAAA/lGLfZ92rPeE/s181-c/108911355181327993622.jpg",
    },
  },
...
export default class AvatarsScreen extends React.Component<InterfaceProps, InterfaceState> {
  constructor(props) {
    super(props);
  }

  private onAvatarPress = (item) => {
