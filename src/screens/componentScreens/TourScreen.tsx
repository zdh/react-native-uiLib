...
import { Colors, View, Text, Button, Assets, Tour } from "react-native-ui-lib/src";

interface InterfaceProps {}

interface InterfaceState {
  showButtonTour?: boolean;
  showIconTour?: boolean;
}
    ...
    return (
      <View flex center>
        ...
        >
          <View>
            <Button
              label={Assets.emojis.tea}
              link
              onPress={() => this.setState({ showIconTour: true })}
            />
          </View>
        </Tour>
      </View>
