...
import { StyleSheet, ScrollView, Alert, ViewStyle, TextStyle } from "react-native";
import {
  Constants,
  Assets,
  Colors,
...
export default class TabBarScreen extends React.Component<InterfaceProps, InterfaceState> {
  constructor(props) {
    super(props);
    ...
    return (
      <ScrollView style={{ backgroundColor: Colors.dark80 }}>
        ...
        <Text style={styles.text}>
          Even a single tab. Note: this tab will get the selected label style
        </Text>
        <TabBar>
          <TabBar.Item
            label="ADD APPS"
        ...
        >
          ...
          <TabBar.Item>
            <Text
              text90
              purple30={selectedIndex1 === 3}
              style={selectedIndex1 === 3 && { fontWeight: fontWeightBold }}
            >
              ABOUT
            </Text>
          </TabBar.Item>
        ...
        >
          <TabBar.Item
            showDivider
            labelStyle={{ color: Colors.dark10 }}
            selectedLabelStyle={{ color: Colors.purple30 }}
            label="ACTIVE"
          />
          <TabBar.Item
            showDivider
          ...
          <TabBar.Item showDivider>
            <Text text90 red30={selectedIndex2 === 4}>
              OVERFLOW
            </Text>
          </TabBar.Item>
          <TabBar.Item
        ...
        >
          <TabBar.Item
            labelStyle={{ color: Colors.dark10 }}
            selectedLabelStyle={{ color: Colors.cyan30 }}
            label="ACTIVE"
          />
          <TabBar.Item
            labelStyle={{ color: Colors.dark10 }}
          ...
          <TabBar.Item>
            <Text text90 cyan30={selectedIndex2 === 4}>
              OVERFLOW
            </Text>
          </TabBar.Item>
          <TabBar.Item
        ...
        >
          <TabBar.Item
            showDivider
            labelStyle={{ color: Colors.dark10 }}
            selectedLabelStyle={{ color: Colors.violet30 }}
            label="ACTIVE"
          />
          <TabBar.Item
            showDivider
        ...
        >
          <TabBar.Item
            ...
            selectedLabelStyle={{ color: Colors.orange30 }}
            label="ACTIVE"
          />
          <TabBar.Item
            maxLines={2}
        ...
        >
          <TabBar.Item
            ...
            selectedLabelStyle={{ color: Colors.green30, fontWeight: "900" }}
            label="ACTIVE"
          />
          <TabBar.Item
            labelStyle={{ color: Colors.green30, fontWeight: fontWeightBold }}
        ...
        <Text style={styles.text}>
          Pass 'ignoreLastTab' to limit the indicator (tab is NOT disabled. Get it's index from
          onTabSelected)
        </Text>
        ...
        <Button
          size={"small"}
          margin-20
          label={`Change index: ${this.state.randomIndex}`}
          onPress={this.changeIndex}
        />
        <TabBar selectedIndex={this.state.randomIndex}>
  ...
  getTabs(showAddTab) {
    ...
    if (showAddTab) {
      ...
      tabs.push(
        this.renderTabs({ id: index, displayLabel: `tab #${index}`, onPress: this.onPressAddTab }),
      );
    }
    return tabs;
  }
  ...
  changeLabels = () => {
    this.count();
    this.setState({ labels: labelsArray[this.state.counter] });
  };

  count() {
    if (this.state.counter < labelsArray.length - 1) {
      this.setState({
