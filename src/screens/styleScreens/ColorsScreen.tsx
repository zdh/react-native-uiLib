...
import { Colors, Typography, View, Text, TouchableOpacity, Toast } from "react-native-ui-lib/src";
...
interface InterfaceStyle {
  container?: ViewStyle;
  pallete?: ViewStyle;
  palletEeColor?: ViewStyle;
  colorBlock?: ViewStyle;
  colorBlockLabel?: ViewStyle;
}
          ...
          {_.map(baseColors, (baseColor) => {
            ...
            return (
              <View key={baseColor} style={{ paddingLeft: 10 }}>
                <Text style={[Typography.text60, { marginBottom: 2, color: Colors.dark30 }]}>
                  {baseColor}s
                </Text>
                <ScrollView
                  horizontal
