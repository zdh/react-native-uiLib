...
import { ScrollView, TouchableOpacity, StyleSheet, FlatList, Image, ViewStyle } from "react-native";
import { Colors, Constants, View, Text } from "react-native-ui-lib/src";
...
const GridListItem = ({ item, index }) => {
  const itemSize =
    (Constants.screenWidth - GUTTER_SIZE * (NUMBER_OF_COLUMNS + 1)) / NUMBER_OF_COLUMNS;
  return (
