...
export class MainStore {
  public navigationData: InterfaceSection[] = [
    {
      title: "Presets",
      data: [
        {
      ...
      data: [
        {
          ...
          screen: "unicorn.components.InputsScreen",
        },
        {
          title: "Masked Inputs",
      ...
      data: [
        {
          ...
          tags: "loading screen",
          screen: "unicorn.screens.LoadingScreen",
        },
        {
          title: "Modal Screen",
          tags: "modal topbar screen",
          screen: "unicorn.screens.ModalScreen",
        },
        {
          title: "State Screen",
