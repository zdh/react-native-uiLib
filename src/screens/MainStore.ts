...
export interface InterfaceNavigationData {
  Presets?: InterfaceItem[];
  Wrappers?: InterfaceItem[];
  Components?: InterfaceItem[];
  NativeComponents?: InterfaceItem[];
  Inputs?: InterfaceItem[];
  Screens?: InterfaceItem[];
  Lists?: InterfaceItem[];
  Animations?: InterfaceItem[];
  Examples?: InterfaceItem[];
}

export class MainStore {
  public navigationData: InterfaceNavigationData = {
    Presets: [
      {
        title: "Border Radius",
        tags: "corener border radius circle",
        screen: "unicorn.style.BorderRadiusesScreen",
      },
      ...
      {
        title: "Spacings",
        tags: "space margins paddings gutter",
        screen: "unicorn.style.SpacingsScreen",
      },
    ...
    Wrappers: [
      ...
      // {title: 'Text', tags: 'text wrapper', screen: 'unicorn.wrappers.TextScreen'},
      {
        ...
        tags: "touchableOpacity wrapper",
        screen: "unicorn.wrappers.TouchableOpacityScreen",
      },
    ],
    Components: [
      {
      ...
      {
        title: "Action Sheet",
        tags: "action sheet cross-platform",
        screen: "unicorn.components.ActionSheetScreen",
      },
      ...
      { title: "Carousel", tags: "carousel", screen: "unicorn.components.CarouselScreen" },
      {
        ...
        screen: "unicorn.components.CheckboxScreen",
      },
      {
      ...
      },
      {
        ...
        screen: "unicorn.components.DialogScreen",
      },
      {
        title: "Feature Highlight",
        tags: "feature overlay",
        screen: "unicorn.components.FeatureHighlightScreen",
      },
      ...
      { title: "Page Control", tags: "page", screen: "unicorn.components.PageControlScreen" },
      {
        ...
        screen: "unicorn.components.RadioButtonScreen",
      },
      ...
      {
        title: "Toast",
        tags: "toast top bottom snackbar",
        screen: "unicorn.components.ToastsScreen",
      },
      {
        title: "Tour",
        tags: "show button tour",
        screen: "unicorn.components.TourScreen",
      },
      {
    ...
    Inputs: [
      ...
      {
        title: "Masked Inputs",
        tags: "text input form mask",
        screen: "unicorn.components.MaskedInputScreen",
      },
    ],
    Screens: [
      ...
      { title: "Modal Screen", tags: "modal topbar screen", screen: "unicorn.screens.ModalScreen" },
      {
        ...
        screen: "unicorn.screens.EmptyStateScreen",
      },
    ],
    Lists: [
    ...
    Animations: [
      {
        ...
        tags: "animated image",
        screen: "unicorn.components.AnimatedImageScreen",
      },
      {
        title: "Card Scanner",
